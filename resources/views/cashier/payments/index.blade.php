                    ...
                    <template x-if="activeTab === 'students'">
                        @forelse($studentSubmissions as $payment)
                            <tr class="hover:bg-slate-50/50">
                                ...
                                <td class="px-6 py-4">
                                    @php
                                        $isFull = optional($payment->tuition)->balance <= 0;
                                    @endphp
                        ...
                        @empty
                            <tr><td colspan="6" class="px-6 py-20 text-center text-slate-300 font-black uppercase text-[10px] tracking-widest">No Submissions Found</td></tr>
                        @endforelse
                    </template>

                    {{-- Tab 2: Cashier Walk-ins --}}
                    <template x-if="activeTab === 'cashier'">
                        ...
                        @empty
                            <tr><td colspan="6" class="px-6 py-20 text-center text-slate-300 font-black uppercase text-[10px] tracking-widest">No Walk-in Records Found</td></tr>
                        @endforelse
                    </template>
                </tbody>
            </table>
